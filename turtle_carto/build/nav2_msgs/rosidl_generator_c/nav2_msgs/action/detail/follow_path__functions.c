  ...
  nav2_msgs__action__FollowPath_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    nav2_msgs__action__FollowPath_Goal * data =
      (nav2_msgs__action__FollowPath_Goal *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!nav2_msgs__action__FollowPath_Goal__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          nav2_msgs__action__FollowPath_Goal__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  nav2_msgs__action__FollowPath_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    nav2_msgs__action__FollowPath_Result * data =
      (nav2_msgs__action__FollowPath_Result *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!nav2_msgs__action__FollowPath_Result__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          nav2_msgs__action__FollowPath_Result__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  nav2_msgs__action__FollowPath_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    nav2_msgs__action__FollowPath_Feedback * data =
      (nav2_msgs__action__FollowPath_Feedback *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!nav2_msgs__action__FollowPath_Feedback__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          nav2_msgs__action__FollowPath_Feedback__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  nav2_msgs__action__FollowPath_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    nav2_msgs__action__FollowPath_SendGoal_Request * data =
      (nav2_msgs__action__FollowPath_SendGoal_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!nav2_msgs__action__FollowPath_SendGoal_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          nav2_msgs__action__FollowPath_SendGoal_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  nav2_msgs__action__FollowPath_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    nav2_msgs__action__FollowPath_SendGoal_Response * data =
      (nav2_msgs__action__FollowPath_SendGoal_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!nav2_msgs__action__FollowPath_SendGoal_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          nav2_msgs__action__FollowPath_SendGoal_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  nav2_msgs__action__FollowPath_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    nav2_msgs__action__FollowPath_GetResult_Request * data =
      (nav2_msgs__action__FollowPath_GetResult_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!nav2_msgs__action__FollowPath_GetResult_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          nav2_msgs__action__FollowPath_GetResult_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  nav2_msgs__action__FollowPath_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    nav2_msgs__action__FollowPath_GetResult_Response * data =
      (nav2_msgs__action__FollowPath_GetResult_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!nav2_msgs__action__FollowPath_GetResult_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          nav2_msgs__action__FollowPath_GetResult_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  nav2_msgs__action__FollowPath_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    nav2_msgs__action__FollowPath_FeedbackMessage * data =
      (nav2_msgs__action__FollowPath_FeedbackMessage *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!nav2_msgs__action__FollowPath_FeedbackMessage__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          nav2_msgs__action__FollowPath_FeedbackMessage__fini(&data[i]);
        }
        free(data);
        return false;
      }
